...
@section('content')
     ...
     <div class="right_col" role="main">
        ...
        <div class="tile_count">
          ...
          <div class="col-md-2 col-sm-4  tile_stats_count">
            <span class="count_top"><i class="fa fa-clock-o"></i> Total Invoices</span>
            <div class="count">{{$totalInvoices}}</div>
          ...
          <div class="col-md-2 col-sm-4  tile_stats_count">
            ...
            <div class="count">{{$totalTeams}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i></i> From last Week</span>
          </div>
          <div class="col-md-2 col-sm-4  tile_stats_count">
            <span class="count_top"><i class="fa fa-user"></i> Total Amounts</span>
            <div class="count">{{$totalAmounts}}</div>
            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i></i> From last Week</span>
          </div>
        </div>
      </div>
